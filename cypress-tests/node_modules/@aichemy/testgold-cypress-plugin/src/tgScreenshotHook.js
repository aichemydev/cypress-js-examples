 ...
 *
 * @param config
 * @returns {{tgEnabled: boolean, walAuthToken: string, walServerUser: string, walServerHost: string}}
 */
function getInterceptorConfig (config) {
  ...
  if (tgEnabled) {
    ...
    const decodedToken = JSON.parse(Buffer.from(tgToken, 'base64').toString())
